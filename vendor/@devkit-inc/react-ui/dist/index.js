...
__export(index_exports, {
  ALL_TOKENS: () => import_theme_tokens4.ALL_TOKENS,
  ANSI_TOKENS: () => import_theme_tokens4.ANSI_TOKENS,
  AppBar: () => AppBar,
  BASE: () => import_theme_tokens3.BASE,
  BUILTIN_THEMES: () => BUILTIN_THEMES,
  BreadcrumbNav: () => BreadcrumbNav,
  CHROME_TOKENS: () => import_theme_tokens4.CHROME_TOKENS,
  Calendar: () => Calendar,
  CheckGlyph: () => CheckGlyph,
  ColumnPanel: () => ColumnPanel,
  ConsolePane: () => ConsolePane,
  DEFAULT_THEME_ID: () => DEFAULT_THEME_ID,
  FullscreenGlyph: () => FullscreenGlyph,
  HUE_NAMES: () => import_theme_tokens4.HUE_NAMES,
  HUE_TOKENS: () => import_theme_tokens4.HUE_TOKENS,
  MaximizeGlyph: () => MaximizeGlyph,
  OPTIONAL_TOKENS: () => import_theme_tokens4.OPTIONAL_TOKENS,
  OverflowMenu: () => OverflowMenu,
  PREPAINT_SNIPPET: () => PREPAINT_SNIPPET,
  RestoreGlyph: () => RestoreGlyph,
  SEMANTIC_TOKENS: () => import_theme_tokens4.SEMANTIC_TOKENS,
  SchemaControls: () => SchemaControls,
  SchemaExplorer: () => SchemaExplorer,
  SchemaExplorerPanel: () => SchemaExplorerPanel,
  ...
  VisualZoomViewport: () => VisualZoomViewport,
  ...
  counterpartTheme: () => counterpartTheme,
  createUseIcon: () => createUseIcon,
  getSavedTheme: () => getSavedTheme,
  getSchemaColor: () => getSchemaColor,
  isThemeToken: () => import_theme_tokens4.isThemeToken,
  loadSelection: () => loadSelection,
  mergeRemoteThemes: () => mergeRemoteThemes,
  parseAnsi: () => parseAnsi,
  parseThemeRow: () => parseThemeRow,
  pickTheme: () => pickTheme,
  readCachedRows: () => readCachedRows,
  rememberPreferred: () => rememberPreferred,
  resolveInitialTheme: () => resolveInitialTheme,
  resolveTheme: () => resolveTheme,
  saveSelection: () => saveSelection,
  themeToCss: () => themeToCss,
  useColumns: () => useColumns,
  useDarkClass: () => useDarkClass,
  useDismiss: () => useDismiss,
  useDocumentTheme: () => useTheme2,
  useFullscreen: () => useFullscreen,
  useMaximized: () => useMaximized,
  useSchemaData: () => useSchemaData,
  useTheme: () => useTheme,
  useThemeRegistry: () => useThemeRegistry,
  useZoomFactor: () => useZoomFactor,
  useZoomNeutral: () => useZoomNeutral
});
...
function useSchemaData(supabase, schemaPrefix) {
  const [fetched, setFetched] = (0, import_react2.useState)(EMPTY);
...
function useColumns(supabase, schemaPrefix, schema, table) {
  ...
  const [fetched, setFetched] = (0, import_react3.useState)({ key: null, columns: [] });
...
function useDarkClass() {
  return (0, import_react4.useSyncExternalStore)(subscribe, getSnapshot, getServerSnapshot);
}
...
var SchemaGroupNode = (0, import_react5.memo)(({ data, style }) => {
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontFamily: "monospace", fontSize: 12, fontWeight: 700, color: color.text, letterSpacing: "0.02em" }, children: schema }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { fontSize: 10, color: color.text, opacity: 0.6 }, children: [
              tableCount,
              " ",
...
var TableNode = (0, import_react6.memo)(({ data, selected }) => {
  const { name, type, color } = data;
  const c = chromeColors(data.theme);
  const isView = type === "VIEW";
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react7.Handle, { type: "target", position: import_react7.Position.Left, style: { opacity: 0, width: 6, height: 6 } }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { fontSize: 9, color: color.text, opacity: 0.7, flexShrink: 0, fontFamily: "monospace" }, children: isView ? "VIEW" : "TBL" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react7.Handle, { type: "source", position: import_react7.Position.Right, style: { opacity: 0, width: 6, height: 6 } })
  ] });
});
...
function ColumnPanel({ supabase, schemaPrefix, schema, table, color, onClose, theme = "dark" }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { padding: "14px 16px 12px", borderBottom: `1px solid ${c.subtle}` }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 4 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontFamily: "monospace", fontSize: 13, fontWeight: 700, color: color?.text ?? c.text2 }, children: table }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontFamily: "monospace", fontSize: 10, color: c.mutedText }, children: schema })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "scroll-slim", style: { flex: 1, overflowY: "auto", padding: "8px 0" }, children: loading ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { padding: "20px 16px", color: c.faintText, fontSize: 12 }, children: "Loading\u2026" }) : columns.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { padding: "20px 16px", color: c.faintText, fontSize: 12 }, children: "No columns found" }) : columns.map((col, i) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: {
      display: "flex",
      alignItems: "baseline",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 6, overflow: "hidden" }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontFamily: "monospace", fontSize: 11, color: c.text, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: col.name })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontFamily: "monospace", fontSize: 10, color: c.mutedText, flexShrink: 0, marginLeft: 8 }, children: shortType(col.dataType) })
    ] }, col.name)) }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { padding: "10px 16px", borderTop: `1px solid ${c.subtle}`, display: "flex", gap: 12 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 5 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { width: 6, height: 6, borderRadius: "50%", background: color?.border ?? c.mutedBorder, display: "inline-block" } }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontSize: 10, color: c.mutedText }, children: "not null" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 5 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { width: 6, height: 6, borderRadius: "50%", background: c.mutedBorder, display: "inline-block" } }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontSize: 10, color: c.mutedText }, children: "nullable" })
      ] })
    ] })
  ] });
}
...
function SchemaControls({ schemas, hidden, tableCountBySchema, onToggle, theme = "dark" }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { fontSize: 10, color: c.mutedText, fontWeight: 600, letterSpacing: "0.06em", marginBottom: 2 }, children: "SCHEMAS" }),
    schemas.map((schema) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { fontFamily: "monospace", fontSize: 11, color: visible ? c.text2 : c.faintText, flex: 1 }, children: schema }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { fontSize: 10, color: c.faintText }, children: count })
          ]
        },
        schema
      );
...
function SchemaExplorer({ supabase, schemaPrefix, hiddenByDefault = [] }) {
  ...
  const [hiddenSchemas, setHiddenSchemas] = (0, import_react8.useState)(new Set(hiddenByDefault));
  const [selected, setSelected] = (0, import_react8.useState)(null);
  const orderedSchemas = (0, import_react8.useMemo)(
    () => [...new Set(tables.map((t) => t.schema))].sort(),
    [tables]
  );
  const tableCountBySchema = (0, import_react8.useMemo)(() => {
    const counts = {};
  ...
  const selectedColor = (0, import_react8.useMemo)(
    () => selected ? getSchemaColor(selected.schema, orderedSchemas, theme) : null,
    [selected, orderedSchemas, theme]
  );
  const onNodeClick = (0, import_react8.useCallback)((_evt, node) => {
  ...
  const toggleSchema = (0, import_react8.useCallback)((schema) => {
  ...
  if (loading) {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", background: c.canvas }, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: { color: c.faintText, fontSize: 13 }, children: "Loading schema\u2026" }) });
  }
  if (error) {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", background: c.canvas }, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { style: { color: dangerText(theme), fontSize: 13 }, children: [
      "Error: ",
      error
    ] }) });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { flex: 1, position: "relative", background: c.canvas, overflow: "hidden" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      import_react9.ReactFlow,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_react9.Background, { variant: import_react9.BackgroundVariant.Dots, gap: 24, size: 1, color: c.subtle }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_react9.Controls, { style: { background: c.panel, border: `1px solid ${c.subtle}` } }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
            import_react9.MiniMap,
            {
...
function SchemaExplorerPanel({ supabase, schemaPrefix, hiddenByDefault = [] }) {
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { flex: 1, minHeight: 0, display: "flex", overflow: "hidden" }, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SchemaExplorer, { supabase, schemaPrefix, hiddenByDefault }) });
}
...
function ThemeProvider({ children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ThemeContext.Provider, { value: { theme, toggle: () => setTheme((t) => t === "dark" ? "light" : "dark"), isManaged: true }, children });
}
...
function YearView({ events, activeDate, onMonthClick, onNavigate, theme }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { fontFamily: "inherit" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: { fontWeight: 600, fontSize: 14 }, children: year }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
        "button",
        {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: { display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: 6 }, children: SHORT_MONTHS.map((label, i) => {
      const month = i + 1;
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
        "div",
        {
          ...
          children: [
            ...
            count > 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: { fontSize: 10, opacity: 0.7, marginTop: 2 }, children: count })
          ]
        },
        label
      );
...
function CrumbTrail({ crumbs, theme }) {
  const c = chromeColors(theme);
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("nav", { "aria-label": "Breadcrumb", style: { display: "flex", alignItems: "center", gap: 6 }, children: crumbs.map((crumb, i) => {
    const isCurrent = i === crumbs.length - 1;
    return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
      i > 0 && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { "aria-hidden": true, style: { color: c.faintText, fontSize: 11 }, children: "\u203A" }),
...
function MonthView({ events, activeDate, onDayClick, onNavigate, onGoToYear, renderEvent, theme }) {
  ...
  const [pickerYear, setPickerYear] = (0, import_react12.useState)(year);
  const [hoveredIso, setHoveredIso] = (0, import_react12.useState)(null);
  const pickerRef = (0, import_react12.useRef)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: { fontFamily: "inherit", position: "relative" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { "aria-label": "Previous month", onClick: prevMonth, style: navButton, children: "\u2039" }),
        ...
        CrumbTrail,
        {
          ...
          crumbs: [
            { label: String(year), onClick: onGoToYear },
            {
              ...
              label: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(import_jsx_runtime10.Fragment, { children: [
                monthName(month),
                /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { "aria-hidden": true, style: { fontSize: 9, color: c.mutedText }, children: pickerOpen ? "\u25B2" : "\u25BC" })
              ] }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { "aria-label": "Next month", onClick: nextMonth, style: navButton, children: "\u203A" })
    ] }),
    pickerOpen && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { ref: pickerRef, style: { position: "absolute", top: 36, left: "50%", transform: "translateX(-50%)", zIndex: 10, background: c.panel, border: cellBorder, borderRadius: 8, padding: 10, minWidth: 200 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { "aria-label": "Previous year", onClick: () => setPickerYear((y) => y - 1), style: { background: "none", border: cellBorder, borderRadius: 4, padding: "2px 8px", cursor: "pointer", color: "inherit", fontSize: 12 }, children: "\u2039" }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { "aria-label": "Picker year", style: { fontWeight: 700, fontSize: 13 }, children: pickerYear }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          "button",
          {
            "aria-label": "Next year",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 4 }, children: MONTH_ABBRS.map((abbr, i) => {
        const m = i + 1;
    ...
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: { display: "grid", gridTemplateColumns: "repeat(7, 1fr)", textAlign: "center", fontSize: 11, borderTop: gridBorder, borderLeft: gridBorder }, children: [
      WEEKDAYS.map((d) => /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { style: { color: c.faintText, fontSize: 10, textTransform: "uppercase", letterSpacing: ".06em", padding: "4px 0", borderRight: gridBorder, borderBottom: gridBorder }, children: d }, d)),
      cells.map((day, i) => {
        if (day === null) return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { style: { borderRight: gridBorder, borderBottom: gridBorder } }, `empty-${i}`);
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { style: { fontSize: 11, color: c.mutedText, fontWeight: isToday ? 700 : 400 }, children: day }),
              /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 2 }, children: [
                visibleDots.map(
                  (e, j) => renderEvent ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { children: renderEvent(e) }, j) : /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { "data-testid": "event-dot", style: { color: e.color, fontSize: 8, textAlign: "center" }, children: "\u25CF" }, j)
                ),
                overflow > 0 && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("span", { style: { fontSize: 8, color: c.mutedText, textAlign: "center" }, children: [
                  "+",
                  overflow
                ] })
              ] })
...
function WeekView({ events, activeDate, onDayClick, onNavigate, onGoToMonth, onGoToYear, theme }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { style: { fontFamily: "inherit" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("button", { "aria-label": "Previous week", onClick: () => onNavigate(addDays(activeDate, -7)), style: navButton, children: "\u2039" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("button", { "aria-label": "Next week", onClick: () => onNavigate(addDays(weekStart, 7)), style: navButton, children: "\u203A" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { style: { display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 4, fontSize: 11 }, children: days.map((iso, i) => {
      const day = parseInt(iso.slice(8), 10);
      const dayEvents = eventsForDate(events, iso);
      return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { style: { background: c.panel, borderRadius: 6, padding: 8, minHeight: 80 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { style: { color: c.mutedText, marginBottom: 4, textAlign: "center" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { children: SHORT_DAYS[i] }),
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { children: day })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 3 }, children: dayEvents.map((e) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
          "div",
          {
            onClick: () => onDayClick(iso, dayEvents),
            style: {
...
function Calendar({ events, defaultView = "month", defaultDate, onDayClick, renderEvent, theme }) {
  ...
  const [view, setView] = (0, import_react13.useState)(defaultView);
  const [activeDate, setActiveDate] = (0, import_react13.useState)(defaultDate ?? (/* @__PURE__ */ new Date()).toISOString().slice(0, 10));
...
function useZoomNeutral(zoom) {
  const [resolved, setResolved] = (0, import_react14.useState)(null);
...
function useZoomFactor(zoom) {
  const [factor, setFactor] = (0, import_react14.useState)(ZOOM_NEUTRAL);
  (0, import_react14.useEffect)(() => {
    if (!zoom) return;
    let cancelled = false;
    void zoom.get().then((f) => {
...
function useDismiss(open, ref, close) {
  const closeRef = (0, import_react15.useRef)(close);
...
function Magnifier({ sign }) {
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("svg", { width: "14", height: "14", viewBox: "0 0 16 16", "aria-hidden": "true", "data-zoom": sign, children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("circle", { cx: "6.5", cy: "6.5", r: "4.5", fill: "none", stroke: "currentColor", strokeWidth: "1.5" }),
    ...
    sign === "plus" && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
      "line",
      {
        x1: "6.5",
        y1: "4",
...
function ZoomIndicator({ bridge }) {
  ...
  const [wasNeutral, setWasNeutral] = (0, import_react16.useState)(atNeutral);
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
          "button",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Magnifier, { sign: factor > (neutral ?? factor) ? "plus" : "minus" })
          }
        ),
        open && !atNeutral && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "ds-zoom-pop", children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { className: "ds-zoom-pct", children: [
            pct,
            "%"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { className: "ds-zoom-step", title: "Zoom out", onClick: () => zoom.out(), children: "\u2212" }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { className: "ds-zoom-step", title: "Zoom in", onClick: () => zoom.in(), children: "+" }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { className: "ds-zoom-reset", title: "Reset to default", onClick: () => zoom.reset(), children: "Reset" })
        ] })
      ]
    }
  );
...
function useMaximized(bridge) {
  const [maximized, setMaximized] = (0, import_react17.useState)(false);
...
function useTheme2() {
  const [theme, setTheme] = (0, import_react18.useState)(
...
function ThemeIcon({ theme }) {
  return theme === "dark" ? /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("svg", { ...ICON, "data-icon": "sun", children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("circle", { cx: "12", cy: "12", r: "4" }),
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("path", { d: "M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41" })
  ] }) : /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("svg", { ...ICON, "data-icon": "moon", children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("path", { d: "M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" }) });
}
function ThemeToggle({ theme, onToggle, className = "ds-appbar-btn" }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
    "button",
    {
      ...
      onClick: toggle,
      children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(ThemeIcon, { theme: current })
    }
  );
}
...
function MaximizeGlyph() {
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("svg", { ...BOX, width: "10", height: "10", "data-icon": "maximize", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("rect", { x: "0.5", y: "0.5", width: "9", height: "9" }) });
}
function RestoreGlyph() {
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("svg", { ...BOX, width: "10", height: "10", "data-icon": "restore", "aria-hidden": "true", children: [
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("rect", { x: "0.5", y: "2.5", width: "7", height: "7" }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("path", { d: "M2.5 2.5V0.5H9.5V7.5H7.5" })
  ] });
}
function FullscreenGlyph() {
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
    "svg",
    {
      ...
      "aria-hidden": "true",
      children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("path", { d: "M0.8 3.4V0.8H3.4M6.6 0.8H9.2V3.4M9.2 6.6V9.2H6.6M3.4 9.2H0.8V6.6" })
    }
  );
}
function CheckGlyph() {
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
    "svg",
    {
      ...
      "data-icon": "check",
      "aria-hidden": "true",
      children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("path", { d: "M1.5 5.5L4 8L8.5 2.5" })
    }
  );
}
...
function Swatch({ theme }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "ds-theme-swatch", style: { background: bg, borderColor: border }, children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { style: { background: accent } }) });
}
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
          "button",
          {
            ...
            onClick: () => setOpen((o) => !o),
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(ThemeIcon, { theme: theme.type }),
              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "ds-menu-label", children: "Theme" }),
              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "ds-submenu-arrow", "aria-hidden": "true", children: "\u2039" })
            ]
          }
        ),
        open && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "ds-submenu-panel scroll-slim", role: "menu", children: groups.map((type) => {
          const inGroup = themes.filter((t) => t.type === type);
          if (!inGroup.length) return null;
          return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { role: "group", "aria-label": GROUP_LABEL[type], children: [
            /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "ds-menu-heading", children: GROUP_LABEL[type] }),
            inGroup.map((t) => /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
              "button",
              {
                className: "ds-menu-item",
                role: "menuitemradio",
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Swatch, { theme: t }),
                  /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "ds-menu-label", children: t.label }),
                  /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "ds-menu-check", children: t.id === theme.id && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(CheckGlyph, {}) })
                ]
              },
              t.id
            ))
...
function OverflowMenu({ theme, onToggle, bridge, themes, items }) {
  ...
  useDismiss(open, ref, () => setOpen(false));
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "ds-menu", ref, children: [
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "ds-menu-panel", role: "menu", children: [
      items?.map((item) => /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
        "button",
        {
          className: "ds-menu-item",
          role: "menuitem",
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: "ds-menu-icon", children: item.icon }),
            /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: "ds-menu-label", children: item.label })
          ]
        },
        item.label
      )),
      themes ? /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(ThemePicker, { registry: themes, onPicked: () => setOpen(false) }) : /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
        "button",
        {
          className: "ds-menu-item",
          role: "menuitem",
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(ThemeIcon, { theme: current }),
            /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: "ds-menu-label", children: current === "dark" ? "Light theme" : "Dark theme" })
          ]
        }
      ),
      fullscreenApi && /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
        "button",
        {
          className: "ds-menu-item",
          role: "menuitem",
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(FullscreenGlyph, {}),
            /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: "ds-menu-label", children: "Full screen" }),
            /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: "ds-menu-check", children: fullscreen && /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(CheckGlyph, {}) })
          ]
        }
      )
    ] })
...
var import_theme_tokens3 = require("@devkit-inc/theme-tokens");
var import_theme_tokens4 = require("@devkit-inc/theme-tokens");

// src/shell/themes/types.ts
var import_theme_tokens = require("@devkit-inc/theme-tokens");
function parseThemeRow(row) {
  ...
  if (row.colors && typeof row.colors === "object" && !Array.isArray(row.colors)) {
    for (const [key, value] of Object.entries(row.colors)) {
      if (typeof value === "string" && value && (0, import_theme_tokens.isThemeToken)(key)) colors[key] = value;
    }
  }
  return {
    id: row.id,
...
var import_theme_tokens2 = require("@devkit-inc/theme-tokens");
function resolveTheme(theme) {
  const out = { ...import_theme_tokens2.BASE[theme.type] };
...
function applyResolvedTheme(theme, tokens = resolveTheme(theme)) {
  ...
  for (const name of import_theme_tokens2.ALL_TOKENS) {
...
function themeToCss(theme, tokens = resolveTheme(theme)) {
  const decls = import_theme_tokens2.ALL_TOKENS.filter((n) => tokens[n]).map((n) => `  ${n}: ${tokens[n]};`).join("\n");
  return `:root {
...
function useThemeRegistry(bridge, storage = localStorage, opts = {}) {
  const [rows, setRows] = (0, import_react22.useState)(() => readCachedRows(storage));
  const [selection, setSelection] = (0, import_react22.useState)(() => loadSelection(storage, opts.defaultThemeId));
  const [loading, setLoading] = (0, import_react22.useState)(Boolean(bridge?.list));
  const touched = (0, import_react22.useRef)(false);
  const themes = (0, import_react22.useMemo)(() => mergeRemoteThemes(rows, opts.themes), [rows, opts.themes]);
  const theme = (0, import_react22.useMemo)(
  ...
  const commit = (0, import_react22.useCallback)(
    (next) => {
  ...
  const select = (0, import_react22.useCallback)(
    (id) => {
...
function AppBar({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "ds-appbar", children: [
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("span", { className: "ds-appbar-brand", children: label }),
    nav && /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(import_jsx_runtime18.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("button", { className: "ds-appbar-nav", title: "Back", onClick: () => window.history.back(), children: "\u2039" }),
    ...
    actions,
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("span", { className: "ds-appbar-drag" }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(ZoomIndicator, { bridge }),
    menu && /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(OverflowMenu, { bridge, themes: manageTheme ? themes : void 0, items: menuItems }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("button", { className: "ds-appbar-btn", title: "Minimize", onClick: () => bridge.minimize(), children: "\u2500" }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
      "button",
      {
        className: "ds-appbar-btn",
        ...
        children: maximized ? /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(RestoreGlyph, {}) : /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(MaximizeGlyph, {})
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
      "button",
...
function VisualZoomViewport({ children, max = 3, className }) {
  const viewportRef = (0, import_react23.useRef)(null);
...
function Arrow({ dir }) {
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("svg", { ...ICON2, width: 16, height: 16, strokeWidth: 2, children: dir === "back" ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("path", { d: "M15 18l-6-6 6-6" }) : /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("path", { d: "M9 18l6-6-6-6" }) });
}
function Reload() {
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("svg", { ...ICON2, width: 15, height: 15, strokeWidth: 2, children: [
    /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("path", { d: "M20 11a8 8 0 1 0-2.3 5.7" }),
    /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("path", { d: "M20 5v6h-6" })
  ] });
}
function CrumbSegment({
  ...
  const label = /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { className: crumb.brand ? "ds-crumb-brand" : "ds-crumb-label", children: crumb.label });
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "ds-crumb", children: [
    hasMenu ? /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("button", { className: "ds-crumb-trigger", onClick: onToggle, "aria-haspopup": "menu", "aria-expanded": open, children: [
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(CrumbIcon, { icon: crumb.icon }),
      label,
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("svg", { ...ICON2, width: 10, height: 10, strokeWidth: 2.5, className: "ds-crumb-caret", "data-open": open || void 0, children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("path", { d: "M6 9l6 6 6-6" }) })
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("span", { className: "ds-crumb-trigger", "data-static": "", children: [
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(CrumbIcon, { icon: crumb.icon }),
      label
    ] }),
    open && hasMenu && /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "ds-crumb-panel", role: "menu", children: [
      options.map((o, i) => /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(import_react24.Fragment, { children: [
        i === dividerAt && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "ds-crumb-divider" }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(CrumbIcon, { icon: o.icon }),
              /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { children: o.label })
            ]
          }
        )
      ] }, o.id)),
      options.length > 0 && actions.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "ds-crumb-divider" }),
      actions.map((a) => /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
        "button",
        {
          role: "menuitem",
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(CrumbIcon, { icon: a.icon }),
            /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { children: a.label })
          ]
        },
        a.id
      ))
...
function BreadcrumbNav({ crumbs, history }) {
  const [openIndex, setOpenIndex] = (0, import_react24.useState)(null);
  const containerRef = (0, import_react24.useRef)(null);
  useDismiss(openIndex !== null, containerRef, () => setOpenIndex(null));
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "ds-crumbs", ref: containerRef, children: [
    history && /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "ds-crumb-history", children: [
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
        "button",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Arrow, { dir: "back" })
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
        "button",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Arrow, { dir: "forward" })
        }
      ),
      history.onReload && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("button", { className: "ds-crumb-arrow", "aria-label": "Reload", title: "Reload", onClick: history.onReload, children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Reload, {}) })
    ] }),
    crumbs.map((crumb, i) => /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(import_react24.Fragment, { children: [
      i > 0 && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { className: "ds-crumb-sep", "aria-hidden": "true", children: "|" }),
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
        CrumbSegment,
        {
          crumb,
...
function ConsolePane({
  ...
  const pinned = (0, import_react25.useRef)(true);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
    "div",
    {
      ...
      children: visible.map((line, i) => /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("div", { className: "console-line", children: parseAnsi(line).map((span, j) => /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("span", { className: span.classes.join(" "), children: span.text }, j)) }, i))
    }
  );
}
